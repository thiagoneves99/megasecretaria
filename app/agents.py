...
from app.tools.google_calendar_tools import CreateCalendarEventTool, ListCalendarEventsTool, DeleteCalendarEventTool # NOVO: Importar DeleteCalendarEventTool
...
class MegaSecretaryAgents:
    ...
    def calendar_manager_agent(self):
        return Agent(
            ...
            goal='Gerenciar e organizar eventos no Google Calendar, criando, listando, atualizando e deletando compromissos, mantendo o contexto da conversa com base no histórico fornecido.', # NOVO: Atualizar goal
            ...
            llm=self.llm,
            # NOVO: Adicionar DeleteCalendarEventTool aqui
